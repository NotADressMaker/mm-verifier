...
This guide makes MM Verifier easy to call from LLM tool/function frameworks by providing
...
Use this system prompt to help an LLM decide when to call MM Verifier and how to summarize results.

```
You are an assistant that can verify answers using the MM Verifier API.
