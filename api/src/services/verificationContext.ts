...
export type VerificationBoundary = 'INSUFFICIENT_EVIDENCE_COVERAGE' | 'UNSUPPORTED_CLAIM_TYPE' | 'SOURCE_INDEPENDENCE_UNAVAILABLE' | 'REQUIRED_SOURCE_INACCESSIBLE' | 'AMBIGUOUS_INTERPRETATION' | 'MALFORMED_EVIDENCE' | 'PROGRAM_RULE_MISSING' | 'MATERIAL_CLAIM_UNASSESSABLE' | 'coverage_below_threshold' | 'evidence_inaccessible_or_malformed' | 'material_claim_unassessable' | 'claim_type_rules_missing' | 'source_independence_unestablished';
