...
router.post('/verify', (req: Request, res: Response) => {
  ...
  logger.info('Education verification completed', { reportId: result.reportId, subject: validation.value.subject, contentLength: validation.value.aiResponse?.length, rawContentPersisted: false });
